    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Cliente>(entity =>
            {
                ...
                entity.Property(e => e.Telefone).HasMaxLength(15).IsUnicode(false);

                entity.HasIndex(e => e.CpfCnpj).IsUnique().HasDatabaseName("IX_Cliente_CpfCnpj");
                entity.HasIndex(e => e.Email).IsUnique().HasDatabaseName("IX_Cliente_Email");
            });
            ...
            modelBuilder.Entity<Venda>(entity =>
            {
                ...
                entity.HasIndex(e => e.IdEndereco).HasDatabaseName("IX_Venda_IdEndereco");
                entity.HasIndex(e => e.IdCliente).HasDatabaseName("IX_Venda_IdCliente");
                entity.HasIndex(e => e.Data).HasDatabaseName("IX_Venda_Data");
            });
            ...
            modelBuilder.Entity<Endereco>(entity =>
            {
                ...
                entity.Property(e => e.IdCliente).IsRequired();
                entity.Property(e => e.TipoEndereco).IsRequired().HasConversion<int>();
                entity.Property(e => e.Logradouro).IsRequired().HasMaxLength(255).IsUnicode(true);
                ...
                entity.HasIndex(e => e.IdCliente).HasDatabaseName("IX_Endereco_IdCliente");
            });
        }
    }
}